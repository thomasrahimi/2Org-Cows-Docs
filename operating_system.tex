...
\begin{enumerate}
 ...
 \end{lstlisting}
  The "Alias" settings maskerade the files, visible to the user with a shorter, easier URL. As the php code mostly refers to the shortened Alias URLs, these entries are essential for the server to work. The ServerName and ServerAlias might be missing, to comply with local DNS settings.
