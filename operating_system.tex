...
Another security mechanism is the definition of available services in the /etc/hosts.allow and /etc/hosts.deny files on the server. This allows to block access all other 
